...
class GraphRelationship(Enum):
    ...
    # Provenance relationships (FAIR compliance - PROV-O)
    GENERATED_BY = "GENERATED_BY"  # DataPiece generated by Run (prov:wasGeneratedBy)
    GENERATED = "GENERATED"  # Run generated DataPiece (prov:generated)
